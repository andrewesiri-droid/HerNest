...
export function TripsScreen({uid,profile}){
  ...
  const planTrip=async(t)=>{
    ...
    const sys=`You are Nora, expert travel concierge. Return ONLY valid JSON. All suggestions should be realistic and well-known. Add a note that prices and hours should be verified before booking. {"overview":"","tripType":"","familyTip":"","highlights":["","",""],"days":[{"day":1,"title":"","plan":"","highlight":"","kidsFriendly":"","soloTip":""}],"packing":${JSON.stringify(packingTemplate)},"checklist":["","","","","",""],"budget":[{"cat":"","amount":"","tip":""}],"bookingTips":""}`;
